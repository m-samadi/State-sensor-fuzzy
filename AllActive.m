% Simulation of the All Active method
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
NodeNumber=40;
NodeList=zeros(NodeNumber,7); % ID | X | Y | RemainingEnergy | Data | Dead RandomRound | Number of Active State
...
while Continue_Flag==1
    ...
    %%% Increase the number of active state
    if mod(RoundNumber,ChangeActiveSleepIntervalTime)==0        
        for i=1:NodeNumber
            NodeList(i,7)=NodeList(i,7)+1;  
        end;
    end;
